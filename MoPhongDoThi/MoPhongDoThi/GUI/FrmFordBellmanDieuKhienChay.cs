...
{
    public partial class FrmFordBellmanDieuKhienChay : Form
    {
        ...
        #region constructor
        public FrmFordBellmanDieuKhienChay()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            ///  cbx Xuat Phat
            cbxDinhXuatPhat.DataSource = Data.Data.graph_FordBellman.dsDinh.ToList();
            cbxDinhXuatPhat.DisplayMember = "Ten";
            cbxDinhXuatPhat.ValueMember = "ID";

            // cbx ket thuc
            cbxDinhKetThuc.DataSource = Data.Data.graph_FordBellman.dsDinh.ToList();
        ...
        private void FrmFordBellmanDieuKhienChay_Load(object sender, EventArgs e)
        {
            LoadInitControl();
