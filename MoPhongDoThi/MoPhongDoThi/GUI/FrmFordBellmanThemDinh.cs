...
{
    public partial class FrmFordBellmanThemDinh : Form
    {
        private int x, y;

        #region constructor
        public FrmFordBellmanThemDinh()
        {
            InitializeComponent();
            x = -1;
            y = -1;
        ...
        public FrmFordBellmanThemDinh(int _x, int _y)
        {
            InitializeComponent();
            x = _x;
            y = _y;
        ...
        private void ThemDinh()
        {
            if (Check())
            {
                ...
                int count = Data.Data.graph_FordBellman.dsDinh.Count;
                if (count == 0) dinh.ID = 1; else dinh.ID = Data.Data.graph_FordBellman.dsDinh[count - 1].ID + 1;
                Data.Data.graph_FordBellman.AddDinh(dinh);
        ...
        #region LoadForm
        private void FrmFordBellmanThemDinh_Load(object sender, EventArgs e)
        {
