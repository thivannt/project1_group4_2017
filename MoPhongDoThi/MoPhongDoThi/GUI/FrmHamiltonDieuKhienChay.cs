...
{
    public partial class FrmHamiltonDieuKhienChay : Form
    {
        ...
        #region constructor
        public FrmHamiltonDieuKhienChay()
        {
            InitializeComponent();
        }
        #endregion
        ...
        {
            ///  cbx Xuat Phat
            cbxDinhXuatPhat.DataSource = Data.Data.graph_Hamilton.dsDinh.ToList();
        ...
        private void FrmHamiltonDieuKhienChay_Load(object sender, EventArgs e)
        {
            LoadInitControl();
