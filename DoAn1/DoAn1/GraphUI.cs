    ...
    partial class GraphUI : Control
    {
        ...
        public bool IsUndirectedGraph
        {
            ...
            set
            {
                ...
                if (value)
                    _penEdge.EndCap = LineCap.NoAnchor; // vo huong
                else
                    _penEdge.EndCap = LineCap.ArrowAnchor;  //co huong
                RefreshMatrix();
                Invalidate();
            }
        }
        ...
        {
            if (_matrix.DijkstraData[x, y].Value == -1)
                return;
            int i = _matrix.DijkstraData[x, y].Previous;
            if (i == -1)
            {
        ...
        private void AddNewNode(Point location)
        {
            ...
            n.DisplayName = (char)(n.Index + '1' - 1);
            n.Location = location;
            this.Controls.Add(n);
